...
const navItems = ["Chat", "Gmail", "Calendar", "Documents", "Automation", "Settings"];
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "TaskPilot is ready. I can summarize Gmail, search emails, create Gmail drafts, read your calendar, and create calendar events.",
      time: "Now",
    },
  ]);
        ...
        <aside className="border-r border-white/10 bg-[#070B18]/80 px-5 py-6 backdrop-blur-xl">
              ...
              return (
                ...
                >
                  ...
                  {!isActive && (
                    ...
                    >
                      {isGoogleTool && googleStatus.connected ? "Connected" : "Soon"}
                    </span>
                  )}
                </button>
              );
          ...
          <div className="mt-10 rounded-3xl border border-white/10 bg-white/[0.04] p-4">
            ...
            <p className="mt-1 text-xs text-slate-400">
              Gmail + Calendar multi-tool agent
            </p>
            <div className="mt-4 h-2 rounded-full bg-slate-800">
              <div className="h-2 w-[72%] rounded-full bg-gradient-to-r from-cyan-400 to-purple-500" />
            </div>
          </div>
        </aside>
          ...
          <header className="mb-6 flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-slate-400">
                One workspace for Gmail, Calendar, tools, documents, and automation.
              </p>
            </div>
        ...
        <aside className="space-y-5 overflow-y-auto border-l border-white/10 bg-[#070B18]/75 p-6 backdrop-blur-xl">
          ...
          <div className="rounded-3xl bg-gradient-to-br from-purple-500/20 to-blue-500/10 p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-300">
              Add document upload and RAG so TaskPilot can answer questions from
              PDFs, notes, and project files.
            </p>
          </div>
        </aside>
      </div>
